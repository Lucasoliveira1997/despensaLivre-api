...
// mongoose.connect('mongodb://localhost:27017/despensalivre', {useNewUrlParser: true, useUnifiedTopology: true })
mongoose.connect('mongodb://localhost:27017/despensalivre', variables.database.options)
